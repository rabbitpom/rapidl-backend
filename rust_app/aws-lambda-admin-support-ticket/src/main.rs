...
async fn main() -> Result<(), common_types_accounts::E> {
    ...
    let router = Router::new()
                    .route("/admin/support/ticket", routing::get(common_types_accounts::Routes::admin::support::ticket::get_request).put(common_types_accounts::Routes::admin::support::ticket::put_request).delete(common_types_accounts::Routes::admin::support::ticket::delete_request))
                    .route("/admin/support/ticket/message", routing::post(common_types_accounts::Routes::admin::support::ticket::post_message_request))
