// You might be looking for aws-lambda-generate
...
async fn main() -> Result<(), common_types_accounts::E> {
    ...
    let router = Router::new()
                    .route("/generated/content/retry", routing::post(common_types_accounts::Routes::generated::content::post_retry_request))
