...
async fn main() -> Result<(), common_types_accounts::E> {
    ...
    let router = Router::new()
                    .route("/subscribe/newsletter", routing::post(common_types_accounts::Routes::subscribe_newsletter::request))
                    .route_layer(axum_middleware::from_fn_with_state(appstate.clone(), common_types_accounts::Middleware::validate_recaptcha_invisible::middleware))
